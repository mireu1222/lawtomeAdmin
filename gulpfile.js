...
gulp.task('html3', async function () {
    return gulp
        .src([paths.html3], { base: src + '/pages3/' })
        .pipe(fileinclude({
            prefix: '@@',
            basepath: src + '/includes/',
            indent: true
...
gulp.task('browserSync', function () {
    ...
    gulp.watch(paths.html3, gulp.series('html3')).on('change', browserSync.reload);
    ...
    gulp.watch(paths.includes, gulp.series('html3')).on('change', browserSync.reload);
...
gulp.task('building', gulp.series(['html', 'html2', 'html3', 'style', 'images', 'fonts', 'scripts']));
